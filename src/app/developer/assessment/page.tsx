...
import { ArrowLeft, ArrowRight, CircleAlert, DoorOpen, EllipsisVertical, FileWarningIcon, HandHelping, Menu, MenuIcon } from 'lucide-react';
...
const page = () => {
    ...
    console.log("showFullscreenWarning", showFullscreenWarning)
