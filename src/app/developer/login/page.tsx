...
export default function Login() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        signupData.append('password', "Zuperscore@2023");
    ...
    return (
        <section className="relative bg-white h-fit lg:h-screen">
            ...
            <div className="relative  flex flex-wrap ">
                <div className="w-full md:w-1/2 h-fit lg:h-screen">
                        ...
                        <div className="flex flex-wrap">
                            <div className="w-full h-fit lg:h-screen">
                                <div className="md:max-w-lg mx-auto text-black">
                                    ...
                                    <h2 className="mb-32 text-5xl md:text-7xl font-bold font-heading tracking-px-n leading-tight ">Sign in and start saving time today.</h2>
                ...
                <div className="w-full md:w-1/2">
                    <div className="p-8 py-16 flex flex-col justify-center items-center bg-blue-50 h-fit lg:h-screen ">
