...
export default function Login() {
    ...
    return (
        <section className="relative bg-white h-screen">
            <img className="absolute left-0 top-0 h-full w-full" src="https://static.shuffle.dev/components/preview/238eb578-e531-4cf4-a658-a1ff13c9b896/assets/public/flaro-assets/images/sign-in/gradient.svg" alt="" />
