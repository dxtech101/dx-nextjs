        ...
        <section className="py-12 md:py-24 bg-neutral-50">
            <div className="container mx-auto px-4">
                <div className="mb-12 md:mb-24 text-center max-w-6xl mx-auto">
                    <h2 className="mb-2 font-semibold text-6xl mx-auto text-black font-heading">Want to find out more about our services?</h2>
                    <p className="text-lg text-gray-500">Your journey to hire smart minded people starts here.</p>
                </div>
                            ...
                            <form className="max-w-2xl mx-auto" action="#">
                                ...
                                <div className="mb-4 border-t border-neutral-100">
                                    <div className="flex flex-wrap">
                                        <div className="w-full md:w-4/12">
                                            <div className="pt-4 md:pb-4 pr-20 border-r border-neutral-100">
                                                <p className="text-xl font-medium tracking-tight text-black">Phone</p>
                                            </div>
                                        </div>
                                        <div className="w-full md:flex-1">
                                            <div className="py-4 md:pl-8">
                                                <input className="block w-full text-xl text-neutral-600 font-medium placeholder-neutral-200 outline-none" type="text" name="email" placeholder="Phone" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="mb-6 border-t border-neutral-100">
                                    <div className="flex flex-wrap">
                                        ...
                                        <div className="w-full md:flex-1 p-4 flex flex-col gap-2">
                                            <label className="relative flex flex-wrap items-center gap-4">
                                                <input className="h-8 w-8 rounded-full" type="radio" name="field-checkbox" value="checkbox-value" />
                                                <span className="text-neutral-500 text-lg font-medium tracking-tight">Developer</span>
                                            </label>
                                            <label className="relative flex flex-wrap items-center gap-4">
                                                <input className="h-8 w-8 rounded-full" type="radio" name="field-checkbox" value="checkbox-value" />
                                                <span className="text-neutral-500 text-lg font-medium tracking-tight">Company looking for Developers</span>
                                            </label>
                                            <label className="relative flex flex-row items-center gap-4">
                                                <input className="h-8 w-8 rounded-full" type="radio" name="field-checkbox" value="checkbox-value" />
                                                <span className="text-neutral-500 text-lg font-medium tracking-tight">Company looking to list developers on our platform</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
