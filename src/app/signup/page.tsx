            ...
            <div className="relative z-10 flex flex-wrap justify-start min-h-screen items-center gap-6 m-0 lg:-m-8">
                ...
                <div className="relative w-full md:w-1/2 flex flex-col justify-center items-center">
                    ...
                    <form onSubmit={handleSubmit} className="w-full lg:w-3/4 flex flex-col gap-6">
                        ...
                        <div className='flex flex-col w-full gap-2'>
                            ...
                            <PhoneInput
                                ...
                                defaultCountry="IN"
                                className={`h-12 pl-4 pr-4 w-full text-black border ${errors.phone ? "border-red-400 bg-red-100" : "border-gray-400 bg-white"} rounded-xl`}
                            />
                        </div>
                    ...
                    <div className='text-sm text-black float-start'>
                        ...
                        <Link
                            href={`/${selected === "Company" ? "company" : "developer"}/login`}
