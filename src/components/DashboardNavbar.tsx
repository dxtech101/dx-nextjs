                ...
                <div className="flex flex-row items-center justify-between w-full">
                    ...
                    <div className='hidden lg:flex items-center justify-end w-full space-x-2'>
                        ...
                        <div className="relative group flex items-center p-1 rounded-full bg-gray-100 gap-1">
                            <img className="w-10 h-10 rounded-full object-cover mr-0 object-top z-0" src={userProfile?.profile_picture || "https://www.tech101.in/wp-content/uploads/2018/07/blank-profile-picture.png"} alt="" />
